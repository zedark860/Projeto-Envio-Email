...
class EmailLoginView(QWidget):
    ...
    def create_data_user(self) -> None:
        ...
        email: str = self.email_envio_edit.text()
        app_password: str = self.senha_app_edit.text()
    ...
    def check_data_user(self) -> None:
        ...
        try:
            ...
            QMessageBox.critical(self, 'Erro', f'Erro ao verificar credenciais, tente novamente!')