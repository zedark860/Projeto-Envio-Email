...
class EmailMainView(QWidget):
    ...
    def init_ui(self, styleMain):
        ...
        layout_limpar_logs = QHBoxLayout()
        layout_limpar_logs.addWidget(self.limpar_logs_button)
        ...
        layout.addWidget(self.limpar_logs_button)
    ...
    def iniciar_envio(self) -> None:
        ...
        if int(self.intervalo_envio_edit.text()) < 30 or int(self.intervalo_envio_edit.text()) > 60:
